...
QT_MOC_LITERAL(7, 83, 6)
    ...
    "ChatWindow\0chatClosing\0\0on_SendButton_clicked\0"
    "recievedMsg\0msg\0removePossilePartner\0"
    "client\0"
};
...
void ChatWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->chatClosing(); break;
        case 1: _t->on_SendButton_clicked(); break;
        case 2: _t->recievedMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->removePossilePartner((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatWindow::chatClosing)) {
                *result = 0;
            }
        }
    }
